...
public class Leaderboard : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        //leaderboard4
        name41.text = SessionData.getLeaderboard(4, 1, "name");
        score41.text = SessionData.getLeaderboard(4, 1, "score");

        name42.text = SessionData.getLeaderboard(4, 2, "name");
        score42.text = SessionData.getLeaderboard(4, 2, "score");

        name43.text = SessionData.getLeaderboard(4, 3, "name");
        score43.text = SessionData.getLeaderboard(4, 3, "score");

        name44.text = SessionData.getLeaderboard(4, 4, "name");
        score44.text = SessionData.getLeaderboard(4, 4, "score");

        name45.text = SessionData.getLeaderboard(4, 5, "name");
        score45.text = SessionData.getLeaderboard(4, 5, "score");
